...
<div class="header-advance-area">
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button"
                                                ...
                                                <span class="admin-name">Admin Khoa</span>
                                                <i style="font-size:13px;" class="bi bi-chevron-down"></i>
                                            </a>
                                            <ul role="menu"
    ...
    <div class="breadcome-area">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="breadcome-list" style="margin:0 !important;margin-top:50px !important;">
                        <div class="row">
                                ...
                                <div class="breadcomb-wp ">
                                    ...
                                    <div class="breadcomb-ctn ">
                                        <div class="" style="height: 100%;display:flex;align-items:center;">
                                            <h2 class="text-uppercase">Giao diện Admin</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="breadcomb-report">
                                    <button data-toggle="tooltip" data-placement="left" title="Download Report"
                                        class="btn"><i class="bi bi-floppy"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
