    ...
    <nav id="sidebar" class="">
        ...
        <div class="nalika-profile">
            <div class="profile-dtl">
                <a href="#"><img src="https://i.pinimg.com/originals/85/6e/5d/856e5deea0e5523660e12f0724736e5f.jpg" alt="" /></a>
                <h2>Admin <span class="min-dtn">Khoa</span></h2>
            </div>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a class="has-arrow" href="{{route('productList')}}" aria-expanded="false">
                            <i class="bi bi-box2"></i>
                            <span class="mini-click-non" style="margin-left: 2px">Sản phẩm</span></a>
